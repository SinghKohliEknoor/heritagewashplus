...
const TouchlessWashPage: React.FC = () => {
  const touchlessWashes = [
    {
      id: 1,
      name: "Basic",
      price: "$11.99",
    ...
    },
    {
      ...
      textColor: "#fff", // White text
      buttonColor: "#ffc300", // Yellow button (back to original)
      features: [
        "Ultimate +",
    ...
    <div className="min-h-screen" style={{ background: '#f8f9fa' }}>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            High-pressure water jets and premium chemicals clean your vehicle without any brushes touching the surface, protecting your paint finish.
          </p>
        </div>
      </section>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div className="text-center">
              ...
              >
                Automated efficiency delivers premium cleaning results at competitive prices for all vehicle types.
              </p>
            </div>
            <div className="text-center">
              <div
              ...
              >
                Automated precision cleaning completed in 5-7 minutes, perfect for busy schedules.
              </p>
            </div>
            <div className="text-center">
              <div
              ...
              >
                Powerful cleaning agents and specialized waxes deliver superior results through precision application.
              </p>
            </div>
          </div>
        </div>
...
export default TouchlessWashPage;
